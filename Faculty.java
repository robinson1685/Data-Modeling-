    ...
    public static void logUserIn(String userName, String Password) throws SQLException{
        ...
        try{
            ...
            // will be null if no user returned
                ...
                boolean b;
     /*       	if ( b = Password.equals(s.getString("password"))) { 
       ...
       */     
        	...
        	ex.printStackTrace();
            System.out.println("\nerror redirecting back to login");
            main(new String[] {});
        }
...
//      System.out.println("Account Deleted.");
    ...
    public static void student_menu(String UID) throws SQLException
    {
        int allow = 1; // used to break the loop around the menu
        int in = 0;
        Scanner stream = new Scanner(System.in);
    ...
    public static void create_prefs(String UID)
    {
        ...
        if(term == 'u' || term == 'U')
        {
            ...
            String query3 = "INSERT INTO summer_schedule_prefs VALUES('"+UID+"','"+term+"',"+year+","+num_of_courses+","+time_of_day_9am+","+time_of_day_12n+","+time_of_day_430pm+",'"+order_pref_1+"','"+order_pref_2+"','"+order_pref_3+"',"+term_a+","+term_b+",'"+term_c+"','"+week8+"','"+week10+"')";
            try
            {
                DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
                Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@olympia.unfcsd.unf.edu:1521:dworcl", "teama4dm1f14", "team4hhrsw");
        ...
        {
            String query2 = "INSERT INTO student_schedule_prefs VALUES('"+UID+"','"+term+"',"+year+","+num_of_courses+","+time_of_day_9am+","+time_of_day_12n+","+time_of_day_430pm+",'"+order_pref_1+"','"+order_pref_2+"','"+order_pref_3+"',"+MW+","+TR+","+MWF+")";
            try
            {
                DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
                Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@olympia.unfcsd.unf.edu:1521:dworcl", "teama4dm1f14", "team4hhrsw");
        ...
        String query1 = "INSERT INTO course_prefs VALUES('"+UID+"','"+term+"',"+year+",'"+crs_num+"','"+crs_name+"',"+pref_rank+")";
        try
        {
            DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
            Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@olympia.unfcsd.unf.edu:1521:dworcl", "teama4dm1f14", "team4hhrsw");
	...
	public static void printforms(String userid) throws SQLException {
		try {
			...
			String sql9 = "SELECT term, year, crs_number, count(crs_number) AS count FROM course_prefs group by crs_number, term, year";
	...
	public static void reviewforms(String userid) {
		try {
			...
			Statement stmt = conn
					.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,
							ResultSet.CONCUR_READ_ONLY);
			String sql8 = "SELECT term, year, crs_number, count(crs_number) AS count FROM faculty_coures group by crs_number, term, year";
...
//-----------------------------------------------------------------------
  public static void chooseReport()
  {
    ...
    String menu_option = console.nextLine();
    String report_type = "";
    ...
    if (menu_option.equals("1"))
      ...
      report_type= "student";
      System.out.println("Enter Report by Letter: ");
      String report = console.nextLine();
